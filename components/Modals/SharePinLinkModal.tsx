...
const SharePinLinkModal = ({ modalOpen, setModalOpen, username }: GetStartedModalProps) => {
  const urls = ['pinlink.bio', 'pinlink.lol', 'pinlinklink.com', 'yoyo.so']
  const socials = [
    {
      icon: FaTwitter,
      name: 'twitter',
    ...
    },
    {
      icon: FaWhatsapp,
      name: 'whatsapp',
      link: `https://wa.me/?text=Check%20out%20my%20pinlink%20over%20on%20${'pinlink.lol'}/${username}`,
    },
    {
      icon: FaLinkedin,
      name: 'linkedin',
      link: `https://www.linkedin.com/sharing/share-offsite/?url=${'pinlink.lol'}/${username}`,
    },
    {
      icon: FaEnvelope,
      name: 'email',
      link: `mailto:?subject=yo!%20check%20out%20my%20brand%20new%20pinlink%20%3A%29&body=Check%20it%20out%20over%20on%20${'pinlink.lol'}/${username}`,
    },
  ]
